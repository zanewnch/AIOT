...
export class RbacInitService {
   ...
   * 初始化所有必要的資料存取層
   */
  constructor( // 建構函式，初始化 RBAC 初始化服務
    permissionRepository: IPermissionRepository = new PermissionRepository(), // 權限資料存取層，負責權限的 CRUD 操作
    roleRepository: IRoleRepository = new RoleRepository(), // 角色資料存取層，負責角色的 CRUD 操作
    rolePermissionRepository: IRolePermissionRepository = new RolePermissionRepository(), // 角色權限關聯資料存取層
    userRepository: IUserRepository = new UserRepository(), // 使用者資料存取層，負責使用者的 CRUD 操作
    userRoleRepository: IUserRoleRepository = new UserRoleRepository() // 使用者角色關聯資料存取層
  ) {
    this.permissionRepository = permissionRepository; // 設定權限資料存取層實例
    this.roleRepository = roleRepository; // 設定角色資料存取層實例
    this.rolePermissionRepository = rolePermissionRepository; // 設定角色權限關聯資料存取層實例
    this.userRepository = userRepository; // 設定使用者資料存取層實例
    this.userRoleRepository = userRoleRepository; // 設定使用者角色關聯資料存取層實例
  }
  /**
   * 建立 RBAC 示範資料
