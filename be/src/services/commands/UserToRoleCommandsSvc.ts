...
export class UserToRoleCommandsSvc {
     ...
     */
    public async assignRolesToUser(request: AssignRolesRequest): Promise<void> {
        try {
     ...
     */
    public async removeRoleFromUser(request: RemoveRoleRequest): Promise<boolean> {
        try {
     ...
     */
    public async updateUserRoles(userId: number, roleIds: number[]): Promise<void> {
        try {
