...
export class UserActivityController {
  ...
  public async getUserActivity(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      // 回傳成功結果，包含完整的活動資料
      const response = ControllerResult.success('User activity data retrieved successfully', activity);
      res.status(response.status).json(response.toJSON());
    } catch (error) {
  ...
  public async recordPageVisit(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      if (!page) {
        ...
        const response = ControllerResult.badRequest('頁面路徑為必填欄位');
        res.status(response.status).json(response.toJSON());
        return;
      }
      ...
      // 回傳成功結果，包含頁面造訪統計資訊
      const response = ControllerResult.success('頁面造訪已記錄', {
        page, // 當前造訪的頁面
  ...
  public async updateSessionInfo(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      if (!activity) {
        ...
        const response = ControllerResult.notFound('使用者活動記錄不存在');
        res.status(response.status).json(response.toJSON());
        return;
      }
      ...
      // 回傳成功結果，包含更新後的活動資料
      const response = ControllerResult.success('會話資訊已更新', activity);
      res.status(response.status).json(response.toJSON());
    } catch (error) {
  ...
  public async getActivityStats(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
      ...
      if (!activity) {
        ...
        const response = ControllerResult.success('Activity statistics retrieved successfully', {
      ...
      // 回傳成功結果，包含完整的統計資料
      const response = ControllerResult.success('Activity statistics retrieved successfully', stats);
      res.status(response.status).json(response.toJSON());
    } catch (error) {
