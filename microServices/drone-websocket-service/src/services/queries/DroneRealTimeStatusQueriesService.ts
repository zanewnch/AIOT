...
import { DroneRealTimeStatusQueriesRepositorysitory } from '@/repo';
import { 
...
import type { IDroneRealTimeStatusQueriesService } from '@/interfaces/services';
 ...
 */
@injectable()
export class DroneRealTimeStatusQueriesService implements IDroneRealTimeStatusQueriesService {
    private repo: DroneRealTimeStatusQueriesRepositorysitory;

    constructor(
        @inject(TYPES.DroneRealTimeStatusQueriesRepositorysitory) repo: DroneRealTimeStatusQueriesRepositorysitory
    ) {
        this.repo = repo;
    }
