 ...
 */
@injectable()
export class DroneRealTimeStatusQueriesController implements IDroneRealTimeStatusQueries {

    constructor(
        @inject(TYPES.IDroneRealTimeStatusQueriesService) 
        private droneRealTimeStatusQueriesService: DroneRealTimeStatusQueriesService
    ) {}
    ...
    getDroneRealTimeStatus = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const droneRealTimeStatus = await this.droneRealTimeStatusQueriesService.getById(id);
    ...
    getAllDroneRealTimeStatuses = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const result = await this.droneRealTimeStatusQueriesService.getAllWithPagination(
                paginationRequest,
                filters
            );
    ...
    getDroneRealTimeStatusByDroneId = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const droneRealTimeStatus = await this.droneRealTimeStatusQueriesService.getByDroneId(droneId);
    ...
    getBatchDroneRealTimeStatuses = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const droneRealTimeStatuses = await this.droneRealTimeStatusQueriesService.getBatchByDroneIds(droneIds);
    ...
    searchDroneRealTimeStatuses = async (req: Request, res: Response): Promise<void> => {
        try {
            ...
            const result = await this.droneRealTimeStatusQueriesService.searchWithPagination(
                keyword,
                paginationRequest,
                filters
            );
    ...
    getDroneRealTimeStatusStatistics = async (req: Request, res: Response): Promise<void> => {
        try {
            const statistics = await this.droneRealTimeStatusQueriesService.getStatistics();
    ...
    getDashboardSummary = async (req: Request, res: Response): Promise<void> => {
        try {
            const summary = await this.droneRealTimeStatusQueriesService.getDashboardSummary();
    ...
    getBatteryStatistics = async (req: Request, res: Response): Promise<void> => {
        try {
            const statistics = await this.droneRealTimeStatusQueriesService.getBatteryStatistics();
    ...
    checkHealth = async (req: Request, res: Response): Promise<void> => {
        try {
            const health = await this.droneRealTimeStatusQueriesService.checkHealth();
    ...
    validateDataIntegrity = async (req: Request, res: Response): Promise<void> => {
        try {
            const validation = await this.droneRealTimeStatusQueriesService.validateDataIntegrity();
