...
export const TYPES = {
    ...
    DroneRealTimeStatusCommandsService: Symbol.for('DroneRealTimeStatusCommandsService'),
    // === 資料存取層 ===
    DroneRealTimeStatusQueriesRepositorysitory: Symbol.for('DroneRealTimeStatusQueriesRepositorysitory'),
    DroneRealTimeStatusCommandsRepositorysitorysitory: Symbol.for('DroneRealTimeStatusCommandsRepositorysitorysitory'),
    // === 控制器層 ===
