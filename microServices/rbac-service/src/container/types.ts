...
export const TYPES = {
  ...
  // ===== Repositorysitory Types =====
   * 使用者查詢 Repositorysitory 類型
  UserQueriesRepositorysitory: Symbol.for('UserQueriesRepositorysitory'),
   * 權限查詢 Repositorysitory 類型
  PermissionQueriesRepositorysitory: Symbol.for('PermissionQueriesRepositorysitory'),
   * 角色查詢 Repositorysitory 類型
  RoleQueriesRepositorysitory: Symbol.for('RoleQueriesRepositorysitory'),
   * 使用者角色查詢 Repositorysitory 類型
  UserRoleQueriesRepositorysitory: Symbol.for('UserRoleQueriesRepositorysitory'),
   * 角色權限查詢 Repositorysitory 類型
  RolePermissionQueriesRepositorysitory: Symbol.for('RolePermissionQueriesRepositorysitory'),
   * 使用者命令 Repositorysitory 類型
  UserCommandsRepositorysitory: Symbol.for('UserCommandsRepositorysitory'),
   * 權限命令 Repositorysitory 類型
  PermissionCommandsRepositorysitory: Symbol.for('PermissionCommandsRepositorysitory'),
   * 角色命令 Repositorysitory 類型
  RoleCommandsRepositorysitory: Symbol.for('RoleCommandsRepositorysitory'),
   * 使用者角色命令 Repositorysitory 類型
  UserRoleCommandsRepositorysitory: Symbol.for('UserRoleCommandsRepositorysitory'),
   * 角色權限命令 Repositorysitory 類型
  RolePermissionCommandsRepositorysitory: Symbol.for('RolePermissionCommandsRepositorysitory'),
   * RBAC MCP 路由類型
