/**
 * @fileoverview 角色命令 Repositorysitory - CQRS 命令端
 * 
...
const logger = createLogger('RoleCommandsRepositorysitory');

/**
 * 角色命令 Repositorysitory 實現類別 - CQRS 命令端
 * 
 * 專門處理角色資料的寫入操作，遵循 CQRS 模式
 * 
 * @class RoleCommandsRepositorysitory
 */
@injectable()
export class RoleCommandsRepositorysitorysitory {
  /**
   * 建立新角色
   * @param roleData 角色資料
