...
export class RbacGrpcServer {
  ...
  constructor() {
    ...
    // 注入依賴
    this.userQueries = container.get<UserQueriesCtrl>(TYPES.UserQueriesController);
    this.userCommands = container.get<UserCommandsCtrl>(TYPES.UserCommandsController);
    this.roleQueries = container.get<RoleQueriesCtrl>(TYPES.RoleQueriesController);
    this.roleCommands = container.get<RoleCommandsCtrl>(TYPES.RoleCommandsController);
    this.permissionQueries = container.get<PermissionQueriesCtrl>(TYPES.PermissionQueriesController);
    this.permissionCommands = container.get<PermissionCommandsCtrl>(TYPES.PermissionCommandsController);
    this.userToRoleQueries = container.get<UserToRoleQueriesCtrl>(TYPES.UserToRoleQueriesController);
    this.userToRoleCommands = container.get<UserToRoleCommandsCtrl>(TYPES.UserToRoleCommandsController);
    this.roleToPermissionQueries = container.get<RoleToPermissionQueriesCtrl>(TYPES.RoleToPermissionQueriesController);
    this.roleToPermissionCommands = container.get<RoleToPermissionCommandsCtrl>(TYPES.RoleToPermissionCommandsController);
