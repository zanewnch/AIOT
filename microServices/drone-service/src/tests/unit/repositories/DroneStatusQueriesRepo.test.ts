/**
 * @fileoverview Unit tests for DroneStatusQueriesRepo
 */

import { DroneStatusQueriesRepo, PaginatedResult } from '../../../repo/queries/DroneStatusQueriesRepo';
...
describe('DroneStatusQueriesRepo - Unit Tests', () => {
  let sequelize: Sequelize;
  let droneStatusRepo: DroneStatusQueriesRepo;

  beforeAll(async () => {
    sequelize = await setupTestDb();
    droneStatusRepo = new DroneStatusQueriesRepo();
  });
  ...
  describe('findPaginated', () => {
    it('should return paginated drone status data', async () => {
      ...
      // Act
      const result: PaginatedResult<DroneStatusModel> = await droneStatusRepo.findPaginated(pagination);
    ...
    it('should apply search filters correctly', async () => {
      ...
      // Act
      const result = await droneStatusRepo.findPaginated(pagination);
    ...
    it('should apply additional filters', async () => {
      ...
      // Act
      const result = await droneStatusRepo.findPaginated(pagination, filters);
  ...
  describe('findByStatusPaginated', () => {
    it('should return drones with specific status', async () => {
      ...
      // Act
      const result = await droneStatusRepo.findByStatusPaginated(DroneStatus.ACTIVE, pagination);
  ...
  describe('findByDroneIdPaginated', () => {
    it('should return status records for specific drone ID', async () => {
      ...
      // Act
      const result = await droneStatusRepo.findByDroneIdPaginated(droneId, pagination);
  ...
  describe('findBySerial', () => {
    it('should return drone status by serial number', async () => {
      ...
      // Act
      const result = await droneStatusRepo.findBySerial(serial);
    ...
    it('should return null for non-existent serial', async () => {
      // Act
      const result = await droneStatusRepo.findBySerial('NON-EXISTENT-SERIAL');
  ...
  describe('findById', () => {
    it('should return drone status by ID', async () => {
      ...
      // Act
      const result = await droneStatusRepo.findById(droneStatus.id);
    ...
    it('should return null for non-existent ID', async () => {
      // Act
      const result = await droneStatusRepo.findById(99999);
  ...
  describe('findAllByStatus', () => {
    it('should return all drones with specific status', async () => {
      ...
      // Act
      const result = await droneStatusRepo.findAllByStatus(DroneStatus.ACTIVE);
    ...
    it('should return empty array for status with no drones', async () => {
      // Act
      const result = await droneStatusRepo.findAllByStatus(DroneStatus.EMERGENCY);
  ...
  describe('Error Handling', () => {
    it('should handle database errors gracefully', async () => {
      ...
      await expect(async () => {
        await droneStatusRepo.findPaginated(pagination);
