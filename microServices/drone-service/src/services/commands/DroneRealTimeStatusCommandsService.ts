 ...
 *
 * @module DroneRealTimeStatusCommandsService
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
...
const logger = createLogger('DroneRealTimeStatusCommandsService');
 ...
 *
 * @class DroneRealTimeStatusCommandsService
 * @since 1.0.0
 */
@injectable()
export class DroneRealTimeStatusCommandsService {
    private repo: DroneRealTimeStatusCommandsRepositorysitory;
    private readonly queryService: DroneRealTimeStatusQueriesService;

    constructor(
        @inject(TYPES.DroneRealTimeStatusCommandsRepositorysitorysitory) repo: DroneRealTimeStatusCommandsRepositorysitorysitory,
