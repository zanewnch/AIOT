 ...
 *
 * @module ArchiveTaskCommandsService
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
 ...
 *
 * @class ArchiveTaskCommandsService
 * @since 1.0.0
 */
@injectable()
export class ArchiveTaskCommandsService {
    private readonly logger = createLogger('ArchiveTaskCommandsService');
    private repo: IArchiveTaskRepositorysitory; // 組合介面

    constructor(
        @inject(TYPES.ArchiveTaskCommandsRepositorysitorysitory) 
        private readonly commandsRepositorysitory: ArchiveTaskCommandsRepositorysitorysitory,
        
        @inject(TYPES.ArchiveTaskQueriesRepositorysitory) 
        private readonly queriesRepositorysitory: ArchiveTaskQueriesRepositorysitory,
        
        @inject(TYPES.ArchiveTaskQueriesService) 
        private readonly queryService: ArchiveTaskQueriesService
    ) {
        // 創建組合repository，支持完整的IArchiveTaskRepositorysitorysitory接口
        ...
        ) as IArchiveTaskRepositorysitory;
    }
