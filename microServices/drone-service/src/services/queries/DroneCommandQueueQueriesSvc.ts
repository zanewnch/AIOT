...
export class DroneCommandQueueQueriesSvc {
    ...
    constructor(
        ...
        private readonly queueRepo: DroneCommandQueueQueriesRepo
    ) {
    }
    ...
    getAllDroneCommandQueuesPaginated = async (
        ...
        try {
            ...
            const result = await this.queueRepo.findPaginated(pagination);
    ...
    getDroneCommandQueuesByDroneIdPaginated = async (
        ...
        try {
            ...
            const result = await this.queueRepo.findByDroneIdPaginated(droneId, pagination);
            // 將 DroneCommandQueueModel 映射為 DroneCommandModel 兼容格式
            const adaptedResult = {
                ...result,
                data: result.data.map((queue: any) => ({
    ...
    getDroneCommandQueuesByStatusPaginated = async (
        ...
        try {
            ...
            const result = await this.queueRepo.findByStatusPaginated(status, pagination);
            // 將 DroneCommandQueueModel 映射為 DroneCommandModel 兼容格式
            const adaptedResult = {
                ...result,
                data: result.data.map((queue: any) => ({
    ...
    getDroneCommandQueuesByPriorityPaginated = async (
        ...
        try {
            ...
            const result = await this.queueRepo.findByPriorityPaginated(priority, pagination);
            // 將 DroneCommandQueueModel 映射為 DroneCommandModel 兼容格式
            const adaptedResult = {
                ...result,
                data: result.data.map((queue: any) => ({
