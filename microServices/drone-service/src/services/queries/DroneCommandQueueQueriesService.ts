 ...
 */
@injectable()
export class DroneCommandQueueQueriesService {

    constructor(
        @inject(TYPES.DroneCommandQueueQueriesRepositorysitory)
        private readonly queueRepositorysitory: DroneCommandQueueQueriesRepositorysitory
    ) {
    }
    ...
    getAllDroneCommandQueuesPaginated = async (
        ...
        try {
            ...
            const result = await this.queueRepositorysitory.findPaginated(pagination);
    ...
    getDroneCommandQueuesByDroneIdPaginated = async (
        ...
        try {
            ...
            const result = await this.queueRepositorysitory.findByDroneIdPaginated(droneId, pagination);
            // 將 DroneCommandQueueModel 映射為 DroneCommandModel 兼容格式
            const adaptedResult = {
                ...result,
                data: result.data.map((queue: any) => ({
    ...
    getDroneCommandQueuesByStatusPaginated = async (
        ...
        try {
            ...
            const result = await this.queueRepositorysitory.findByStatusPaginated(status, pagination);
            // 將 DroneCommandQueueModel 映射為 DroneCommandModel 兼容格式
            const adaptedResult = {
                ...result,
                data: result.data.map((queue: any) => ({
    ...
    getDroneCommandQueuesByPriorityPaginated = async (
        ...
        try {
            ...
            const result = await this.queueRepositorysitory.findByPriorityPaginated(priority, pagination);
            // 將 DroneCommandQueueModel 映射為 DroneCommandModel 兼容格式
            const adaptedResult = {
                ...result,
                data: result.data.map((queue: any) => ({
