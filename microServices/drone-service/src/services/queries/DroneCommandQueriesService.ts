 ...
 */
@injectable()
export class DroneCommandQueriesService {
    constructor(
        @inject(TYPES.DroneCommandQueriesRepositorysitory)
        private readonly commandRepositorysitory: IDroneCommandRepositorysitorysitory,
        @inject(TYPES.DroneCommandQueriesRepositorysitory)
        private readonly queriesRepositorysitory: DroneCommandQueriesRepositorysitory
    ) {}
    ...
    getCommandsByDroneIdPaginated = async (
        ...
        try {
            ...
            const result = await this.queriesRepositorysitory.findByDroneIdPaginated(droneId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneCommandResponse(result);
