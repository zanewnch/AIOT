 ...
 */
@injectable()
export class DronePositionQueriesService implements IDronePositionQueriesService {
    constructor(
        @inject(TYPES.DronePositionQueriesRepositorysitory) private readonly dronePositionRepositorysitory: DronePositionQueriesRepositorysitory
    ) {}
    ...
    getAllPositionsPaginated = async (
        ...
        try {
            ...
            const result = await this.dronePositionRepositorysitory.findPaginated(pagination);
    ...
    getPositionsByDroneIdPaginated = async (
        ...
        try {
            ...
            const result = await this.dronePositionRepositorysitory.findByDroneIdPaginated(droneId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDronePositionResponse(result);
    ...
    getPositionsByIdPaginated = async (
        ...
        try {
            ...
            const result = await this.dronePositionRepositorysitory.findByIdPaginated(id, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDronePositionResponse(result);
    ...
    getPositionsByTimeRangePaginated = async (
        ...
        try {
            ...
            const result = await this.dronePositionRepositorysitory.findByTimeRangePaginated(startTime, endTime, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDronePositionResponse(result);
