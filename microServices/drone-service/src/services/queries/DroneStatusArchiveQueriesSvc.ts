...
export class DroneStatusArchiveQueriesSvc {
    constructor(
        ...
        private readonly droneStatusArchiveQueriesRepo: DroneStatusArchiveQueriesRepo
    ) {}
    ...
    getAllStatusArchivesPaginated = async (
        ...
        try {
            ...
            const result = await this.droneStatusArchiveQueriesRepo.findPaginated(pagination);
    ...
    getStatusArchivesByDroneIdPaginated = async (
        ...
        try {
            ...
            const result = await this.droneStatusArchiveQueriesRepo.findByDroneIdPaginated(droneId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneStatusArchiveResponse(result);
    ...
    getStatusArchivesByStatusPaginated = async (
        ...
        try {
            ...
            const result = await this.droneStatusArchiveQueriesRepo.findByStatusPaginated(status, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneStatusArchiveResponse(result);
    ...
    getStatusArchivesByDateRangePaginated = async (
        ...
        try {
            ...
            const result = await this.droneStatusArchiveQueriesRepo.findByDateRangePaginated(startDate, endDate, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneStatusArchiveResponse(result);
