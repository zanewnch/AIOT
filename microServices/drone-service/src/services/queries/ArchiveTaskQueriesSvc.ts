...
export class ArchiveTaskQueriesSvc {
    ...
    constructor(
        @inject(TYPES.ArchiveTaskQueriesRepo) archiveTaskQueriesRepo: ArchiveTaskQueriesRepo
    ) {
        this.archiveTaskQueriesRepo = archiveTaskQueriesRepo;
    }
    ...
    getAllTasksPaginated = async (
        ...
        try {
            ...
            const result = await this.archiveTaskQueriesRepo.findPaginated(pagination);
    ...
    getTasksByStatusPaginated = async (
        ...
        try {
            ...
            const result = await this.archiveTaskQueriesRepo.findByStatusPaginated(status, pagination);
            const paginatedResponse = DtoMapper.toPaginatedArchiveTaskResponse(result);
    ...
    getTasksByJobTypePaginated = async (
        ...
        try {
            ...
            const result = await this.archiveTaskQueriesRepo.findByJobTypePaginated(jobType, pagination);
            const paginatedResponse = DtoMapper.toPaginatedArchiveTaskResponse(result);
    ...
    getTasksByBatchIdPaginated = async (
        ...
        try {
            ...
            const result = await this.archiveTaskQueriesRepo.findByBatchIdPaginated(batchId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedArchiveTaskResponse(result);
