 ...
 */
@injectable()
export class DronePositionsArchiveQueriesService {
    constructor(
        @inject(TYPES.DronePositionsArchiveQueriesRepositorysitory)
        private readonly archiveRepositorysitory: DronePositionsArchiveQueriesRepositorysitory
    ) {}
    ...
    getPositionsArchiveByBatchIdPaginated = async (
        ...
        try {
            ...
            const result = await this.archiveRepositorysitory.findByBatchIdPaginated(batchId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDronePositionsArchiveResponse(result);
    ...
    getPositionsArchiveByTimeRangePaginated = async (
        ...
        try {
            ...
            const result = await this.archiveRepositorysitory.findByTimeRangePaginated(startTime, endTime, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDronePositionsArchiveResponse(result);
