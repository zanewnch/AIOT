 ...
 *
 * @module DronePositionsArchiveQueriesService
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
...
const logger = createLogger('DronePositionsArchiveQueriesService');
 ...
 * 所有方法都是唯讀操作，不會修改系統狀態。
 *
 * @class DronePositionsArchiveQueriesService
 * @since 1.0.0
 */
@injectable()
export class DronePositionsArchiveQueriesSvc {
    constructor(
        ...
        private readonly dronePositionsArchiveQueriesRepo: DronePositionsArchiveQueriesRepo
    ) {}
    ...
    getAllPositionsArchivePaginated = async (
        ...
        try {
            ...
            const result = await this.dronePositionsArchiveQueriesRepo.findPaginated(pagination);
    ...
    getPositionsArchiveByDroneIdPaginated = async (
        ...
        try {
            ...
            const result = await this.dronePositionsArchiveQueriesRepo.findByDroneIdPaginated(droneId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDronePositionsArchiveResponse(result);
    ...
    getPositionsArchiveByBatchIdPaginated = async (
        ...
        try {
            ...
            const result = await this.dronePositionsArchiveQueriesRepo.findByBatchIdPaginated(batchId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDronePositionsArchiveResponse(result);
    ...
    getPositionsArchiveByTimeRangePaginated = async (
        ...
        try {
            ...
            const result = await this.dronePositionsArchiveQueriesRepo.findByTimeRangePaginated(startTime, endTime, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDronePositionsArchiveResponse(result);
