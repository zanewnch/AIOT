...
export class DroneCommandsArchiveQueriesSvc {
    constructor(
        ...
        private readonly droneCommandsArchiveQueriesRepo: DroneCommandsArchiveQueriesRepo
    ) {}
    ...
    getAllCommandsArchivePaginated = async (
        ...
        try {
            ...
            const result = await this.droneCommandsArchiveQueriesRepo.findPaginated(pagination);
    ...
    getCommandsArchiveByDroneIdPaginated = async (
        ...
        try {
            ...
            const result = await this.droneCommandsArchiveQueriesRepo.findByDroneIdPaginated(droneId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneCommandsArchiveResponse(result);
    ...
    getCommandsArchiveByCommandTypePaginated = async (
        ...
        try {
            ...
            const result = await this.droneCommandsArchiveQueriesRepo.findByCommandTypePaginated(commandType, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneCommandsArchiveResponse(result);
    ...
    getCommandsArchiveByStatusPaginated = async (
        ...
        try {
            ...
            const result = await this.droneCommandsArchiveQueriesRepo.findByStatusPaginated(status, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneCommandsArchiveResponse(result);
