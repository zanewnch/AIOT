 ...
 *
 * @module DroneStatusArchiveQueriesService
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
...
const logger = createLogger('DroneStatusArchiveQueriesService');
 ...
 * 所有方法都是唯讀操作，不會修改系統狀態。
 *
 * @class DroneStatusArchiveQueriesService
 * @since 1.0.0
 */
@injectable()
export class DroneStatusArchiveQueriesService {
    constructor(
        @inject(TYPES.DroneStatusArchiveQueriesRepositorysitory)
        private readonly archiveRepositorysitorysitory: DroneStatusArchiveQueriesRepositorysitory
    ) {}
    ...
    getAllStatusArchivesPaginated = async (
        ...
        try {
            ...
            const result = await this.archiveRepositorysitorysitory.findPaginated(pagination);
    ...
    getStatusArchivesByDroneIdPaginated = async (
        ...
        try {
            ...
            const result = await this.archiveRepositorysitorysitory.findByDroneIdPaginated(droneId, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneStatusArchiveResponse(result);
    ...
    getStatusArchivesByStatusPaginated = async (
        ...
        try {
            ...
            const result = await this.archiveRepositorysitorysitory.findByStatusPaginated(status, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneStatusArchiveResponse(result);
    ...
    getStatusArchivesByDateRangePaginated = async (
        ...
        try {
            ...
            const result = await this.archiveRepositorysitorysitory.findByDateRangePaginated(startDate, endDate, pagination);
            const paginatedResponse = DtoMapper.toPaginatedDroneStatusArchiveResponse(result);
