/**
 * @fileoverview 無人機指令佇列查詢 Repositorysitory - CQRS 查詢端
 *
...
const logger = createLogger('DroneCommandQueueQueriesRepository');
...
/**
 * 無人機指令佇列查詢 Repositorysitory 實現類別 - CQRS 查詢端
 *
 * 專門處理無人機指令佇列資料的查詢操作，遵循 CQRS 模式
 *
 * @class DroneCommandQueueQueriesRepository
 */
@injectable()
export class DroneCommandQueueQueriesRepo {
