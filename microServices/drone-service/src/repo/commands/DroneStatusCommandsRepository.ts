/**
 * @fileoverview 無人機狀態命令 Repositorysitorysitory - CQRS 命令端
 * 
...
const logger = createLogger('DroneStatusCommandsRepositorysitorysitory');

/**
 * 無人機狀態命令 Repositorysitorysitory 實現類別 - CQRS 命令端
 * 
