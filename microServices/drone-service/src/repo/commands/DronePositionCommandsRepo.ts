/**
 * @fileoverview 無人機位置命令 Repositorysitory - CQRS 命令端
 *
...
/**
 * 無人機位置命令 Repositorysitory 實現類別 - CQRS 命令端
 *
 * 專門處理無人機位置資料的寫入操作，遵循 CQRS 模式
 *
 * @class DronePositionCommandsRepositorysitory
 */
@injectable()
export class DronePositionCommandsRepo {
    private readonly logger = createLogger('DronePositionCommandsRepositorysitory');
