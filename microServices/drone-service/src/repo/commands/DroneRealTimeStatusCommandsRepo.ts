/**
 * @fileoverview 無人機即時狀態命令 Repositorysitory - CQRS 命令端
 *
...
/**
 * 無人機即時狀態命令 Repositorysitory 實現類別 - CQRS 命令端
 *
 * 專門處理無人機即時狀態資料的寫入操作，遵循 CQRS 模式
 *
 * @class DroneRealTimeStatusCommandsRepositorysitory
 */
@injectable()
export class DroneRealTimeStatusCommandsRepo {
    private readonly logger = createLogger('DroneRealTimeStatusCommandsRepositorysitory');
