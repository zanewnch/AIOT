/**
 * @fileoverview 無人機狀態歷史命令 Repositorysitory - CQRS 命令端
 *
...
/**
 * 無人機狀態歷史命令 Repositorysitory 實現類別 - CQRS 命令端
 *
 * 專門處理無人機狀態變更歷史資料的寫入操作，遵循 CQRS 模式
 *
 * @class DroneStatusArchiveCommandsRepositorysitory
 */
@injectable()
export class DroneStatusArchiveCommandsRepo {
    private readonly logger = createLogger('DroneStatusArchiveCommandsRepositorysitory');
