/**
 * @fileoverview 無人機位置歷史歸檔命令 Repositorysitory - CQRS 命令端
 *
...
/**
 * 無人機位置歷史歸檔命令 Repositorysitory 實現類別 - CQRS 命令端
 *
 * 專門處理無人機位置歷史歸檔資料的寫入操作，遵循 CQRS 模式
 *
 * @class DronePositionsArchiveCommandsRepositorysitory
 */
@injectable()
export class DronePositionsArchiveCommandsRepo {
    private readonly logger = createLogger('DronePositionsArchiveCommandsRepositorysitory');
