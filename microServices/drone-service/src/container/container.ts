...
import { DroneStatusCommandsRepo } from '../repo/commands/DroneStatusCommandsRepo.js';
import { DroneRealTimeStatusQueriesRepo } from '../repo/queries/DroneRealTimeStatusQueriesRepo.js';
import { DroneRealTimeStatusCommandsRepo } from '../repo/commands/DroneRealTimeStatusCommandsRepo.js';
...
import { DroneStatusArchiveCommandsRepo } from '../repo/commands/DroneStatusArchiveCommandsRepo.js';
...
import { DroneCommandsArchiveCommandsRepo } from '../repo/commands/DroneCommandsArchiveCommandsRepo.js';
import { DroneCommandQueueQueriesRepo } from '../repo/queries/DroneCommandQueueQueriesRepo.js';
import { DroneCommandQueueCommandsRepo } from '../repo/commands/DroneCommandQueueCommandsRepo.js';
import { DronePositionsArchiveQueriesRepo } from '../repo/queries/DronePositionsArchiveQueriesRepo.js';
import { DronePositionsArchiveCommandsRepo } from '../repo/commands/DronePositionsArchiveCommandsRepo.js';
...
export function createContainer(): Container {
    ...
    container.bind(TYPES.DronePositionCommandsRepo).to(DronePositionCommandsRepo).inSingletonScope();
    container.bind(TYPES.DroneStatusQueriesRepo).to(DroneStatusQueriesRepo).inSingletonScope();
    container.bind(TYPES.DroneStatusCommandsRepo).to(DroneStatusCommandsRepo).inSingletonScope();
    container.bind(TYPES.DroneRealTimeStatusQueriesRepo).to(DroneRealTimeStatusQueriesRepo).inSingletonScope();
    container.bind(TYPES.DroneRealTimeStatusCommandsRepo).to(DroneRealTimeStatusCommandsRepo).inSingletonScope();
    container.bind(TYPES.ArchiveTaskQueriesRepo).to(ArchiveTaskQueriesRepo).inSingletonScope();
    container.bind(TYPES.ArchiveTaskCommandsRepo).to(ArchiveTaskCommandsRepo).inSingletonScope();
    container.bind(TYPES.DroneStatusArchiveQueriesRepo).to(DroneStatusArchiveQueriesRepo).inSingletonScope();
    container.bind(TYPES.DroneStatusArchiveCommandsRepo).to(DroneStatusArchiveCommandsRepo).inSingletonScope();
    container.bind(TYPES.DroneCommandQueriesRepo).to(DroneCommandQueriesRepo).inSingletonScope();
    container.bind(TYPES.DroneCommandCommandsRepo).to(DroneCommandCommandsRepo).inSingletonScope();
    container.bind(TYPES.DroneCommandsArchiveQueriesRepo).to(DroneCommandsArchiveQueriesRepo).inSingletonScope();
    container.bind(TYPES.DroneCommandsArchiveCommandsRepo).to(DroneCommandsArchiveCommandsRepo).inSingletonScope();
    container.bind(TYPES.DroneCommandQueueQueriesRepo).to(DroneCommandQueueQueriesRepo).inSingletonScope();
    container.bind(TYPES.DroneCommandQueueCommandsRepo).to(DroneCommandQueueCommandsRepo).inSingletonScope();
    container.bind(TYPES.DronePositionsArchiveQueriesRepo).to(DronePositionsArchiveQueriesRepo).inSingletonScope();
    container.bind(TYPES.DronePositionsArchiveCommandsRepo).to(DronePositionsArchiveCommandsRepo).inSingletonScope();
