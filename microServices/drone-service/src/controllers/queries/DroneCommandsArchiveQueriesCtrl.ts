 ...
 *
 * @module DroneCommandsArchiveQueriesController
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
...
const logger = createLogger('DroneCommandsArchiveQueriesController');
 ...
 * 所有方法都是唯讀操作，不會修改系統狀態。
 *
 * @class DroneCommandsArchiveQueriesController
 * @since 1.0.0
 */
@injectable()
