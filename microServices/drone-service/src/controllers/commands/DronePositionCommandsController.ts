 ...
 *
 * @module DronePositionCommandsController
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
...
import {DronePositionCommandsService} from "./../../services/commands/from.*Service.jsCommandsService.js"';
...
const logger = createLogger('DronePositionCommandsController');
 ...
 *
 * @class DronePositionCommandsController
 * @since 1.0.0
 */
@injectable()
