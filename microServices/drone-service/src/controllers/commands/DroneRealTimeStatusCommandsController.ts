 ...
 *
 * @module DroneRealTimeStatusCommandsController
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
...
import {DroneRealTimeStatusCommandsService} from "./../../services/commands/from.*Service.jsCommandsService.js"';
 ...
 *
 * @class DroneRealTimeStatusCommandsController
 * @since 1.0.0
 */
@injectable()
