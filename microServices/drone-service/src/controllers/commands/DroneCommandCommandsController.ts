 ...
 *
 * @module DroneCommandCommandsController
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
...
const logger = createLogger('DroneCommandCommandsController');
 ...
 *
 * @class DroneCommandCommandsController
 * @since 1.0.0
 */
@injectable()
export class DroneCommandCommandsController {
     ...
     */
    createCommandsControllerBatch = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
