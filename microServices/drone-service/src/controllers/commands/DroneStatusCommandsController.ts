 ...
 *
 * @module DroneStatusCommandsController
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
...
import {DroneStatusCommandsService} from "./../../services/commands/from.*Service.jsCommandsService.js"';
...
const logger = createLogger('DroneStatusCommandsController');
 ...
 *
 * @class DroneStatusCommandsController
 * @since 1.0.0
 */
@injectable()
