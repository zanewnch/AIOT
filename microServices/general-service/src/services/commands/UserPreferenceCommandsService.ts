 ...
 *
 * @module UserPreferenceCommandsService
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
 ...
 *
 * @class UserPreferenceCommandsService
 * @since 1.0.0
 */
@injectable()
export class UserPreferenceCommandsService {
    constructor(
        @inject(TYPES.UserPreferenceCommandsRepository) 
