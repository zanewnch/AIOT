 ...
 * 
 * @module UserPreferenceQueriesController
 * @author AIOT Team
 * @since 1.0.0
 * @version 1.0.0
 */
 ...
 * 
 * @class UserPreferenceQueriesController
 * @since 1.0.0
 */
@injectable()
export class class UserPreferenceQueriesCtrl {Ctrl {
    ...
    getAllUserPreferences = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            const preferences = await this.userPreferenceQueriesService.getAllUserPreferences(limit);
    ...
    getUserPreferenceById = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            const preference = await this.userPreferenceQueriesService.getUserPreferenceById(id);
    ...
    getUserPreferenceByUserId = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            const preference = await this.userPreferenceQueriesService.getUserPreferenceByUserId(userId);
            
            if (!preference) {
                // 返回預設值而不是 404
                const defaultPreference = await this.userPreferenceQueriesService.getUserPreferenceOrDefault(userId);
    ...
    getUserPreferencesByTheme = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            const result_data = await this.userPreferenceQueriesService.getUserPreferencesByTheme(theme, pagination);
    ...
    getUserPreferencesWithPagination = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            const result_data = await this.userPreferenceQueriesService.getUserPreferencesWithPagination(pagination);
    ...
    searchUserPreferences = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            const result_data = await this.userPreferenceQueriesService.searchUserPreferences(searchCriteria, pagination);
    ...
    getUserPreferenceStatistics = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            const statistics = await this.userPreferenceQueriesService.getUserPreferenceStatistics();
    ...
    checkUserPreferenceExists = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            const exists = await this.userPreferenceQueriesService.checkUserPreferenceExists(userId);
