/**
 * @fileoverview Unit tests for UserPreferenceQueriesRepositorysitorysitory
 */
...
describe('UserPreferenceQueriesRepositorysitorysitory - Unit Tests', () => {
  let sequelize: Sequelize;
  let userPreferenceRepositorysitorysitory: UserPreferenceQueriesRepositorysitorysitory;

  beforeAll(async () => {
    sequelize = await setupTestDb();
    userPreferenceRepositorysitorysitory = new UserPreferenceQueriesRepositorysitorysitory();
  });
  ...
  describe('selectAll', () => {
    it('should return all user preferences with default limit', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectAll();
    ...
    it('should respect custom limit parameter', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectAll(3);
    ...
    it('should throw error when database operation fails', async () => {
      ...
      // Act & Assert
      await expect(userPreferenceRepositorysitorysitory.selectAll()).rejects.toThrow('Database error');
  ...
  describe('selectById', () => {
    it('should return user preference by ID', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectById(preference.id);
    ...
    it('should return null for non-existent ID', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectById(99999);
    ...
    it('should throw error for invalid ID type', async () => {
      // Act & Assert
      await expect(userPreferenceRepositorysitorysitory.selectById('invalid' as any)).rejects.toThrow();
    });
  });
  ...
  describe('selectByUserId', () => {
    it('should return user preference by user ID', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectByUserId(userId);
    ...
    it('should return null for non-existent user ID', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectByUserId(99999);
  ...
  describe('selectByTheme', () => {
    it('should return paginated preferences by theme', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectByTheme('dark', { page: 1, limit: 10 });
    ...
    it('should handle pagination correctly', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectByTheme('dark', { page: 2, limit: 2 });
    ...
    it('should return empty result for non-existent theme', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectByTheme('non-existent-theme');
    ...
    it('should use default pagination when not provided', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectByTheme('auto');
  ...
  describe('selectByLanguage', () => {
    it('should return paginated preferences by language', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectByLanguage('zh-TW');
    ...
    it('should handle different language codes', async () => {
      ...
      for (const lang of languages) {
        const result = await userPreferenceRepositorysitorysitory.selectByLanguage(lang);
  ...
  describe('selectByTimezone', () => {
    it('should return paginated preferences by timezone', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectByTimezone('Asia/Taipei');
    ...
    it('should handle different timezone formats', async () => {
      ...
      for (const tz of timezones) {
        const result = await userPreferenceRepositorysitorysitory.selectByTimezone(tz);
        expect(result.items).toHaveLength(1);
  ...
  describe('selectWithPagination', () => {
    it('should return paginated preferences', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectWithPagination({ page: 2, limit: 5 });
    ...
    it('should use default pagination parameters', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectWithPagination();
  ...
  describe('count', () => {
    it('should return correct count of user preferences', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.count();
  ...
  describe('existsByUserId', () => {
    it('should return true when user preference exists', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.existsByUserId(userId);
    ...
    it('should return false when user preference does not exist', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.existsByUserId(99999);
  ...
  describe('search', () => {
    ...
    it('should search by userId', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.search({ userId: 1 });
    ...
    it('should search by theme', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.search({ theme: 'dark' });
    ...
    it('should search by language', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.search({ language: 'en-US' });
    ...
    it('should search by timezone', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.search({ timezone: 'Asia/Taipei' });
    ...
    it('should search with multiple criteria', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.search({
        theme: 'dark',
        language: 'zh-TW'
      });
    ...
    it('should return empty result when no matches found', async () => {
      // Act
      const result = await userPreferenceRepositorysitorysitory.search({ theme: 'non-existent' });
  ...
  describe('Error Handling', () => {
    it('should handle database connection errors', async () => {
      ...
      // Act & Assert
      await expect(userPreferenceRepositorysitorysitory.selectAll()).rejects.toThrow('Connection failed');
    ...
    it('should handle invalid pagination parameters gracefully', async () => {
      ...
      await expect(async () => {
        await userPreferenceRepositorysitorysitory.selectWithPagination({ page: -1, limit: 0 });
      }).not.toThrow();
    });
    ...
    it('should handle SQL injection attempts in search', async () => {
      ...
      await expect(async () => {
        await userPreferenceRepositorysitorysitory.search({ theme: maliciousInput });
      }).not.toThrow();
    });
  });
  ...
  describe('Performance Tests', () => {
    it('should handle large datasets efficiently', async () => {
      ...
      // Act
      const result = await userPreferenceRepositorysitorysitory.selectWithPagination({ page: 5, limit: 20 });
    ...
    it('should efficiently count large datasets', async () => {
      ...
      // Act
      const count = await userPreferenceRepositorysitorysitory.count();
