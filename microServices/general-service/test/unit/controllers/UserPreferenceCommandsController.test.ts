...
describe('UserPreferenceCommands', () => {
    ...
    let mockUserPreferenceCommandsService: jest.Mocked<UserPreferenceCommandsService>;
    ...
    beforeEach(() => {
        ...
        // Mock UserPreferenceCommandsService
        mockUserPreferenceCommandsService = {
        ...
        controller = new UserPreferenceCommands(mockUserPreferenceCommandsService);
    ...
    describe('createUserPreference', () => {
        it('應該成功創建用戶偏好設定', async () => {
            ...
            mockUserPreferenceCommandsService.createUserPreference.mockResolvedValue({
                success: true,
            ...
            expect(mockUserPreferenceCommandsService.createUserPreference).toHaveBeenCalledWith(preferenceData);
        ...
        it('應該在缺少用戶 ID 時返回錯誤', async () => {
            ...
            expect(mockUserPreferenceCommandsService.createUserPreference).not.toHaveBeenCalled();
        });
        ...
        it('應該處理服務拋出的異常', async () => {
            ...
            mockUserPreferenceCommandsService.createUserPreference.mockRejectedValue(error);
    ...
    describe('updateUserPreference', () => {
        it('應該成功更新用戶偏好設定', async () => {
            ...
            mockUserPreferenceCommandsService.updateUserPreference.mockResolvedValue({
                success: true,
            ...
            expect(mockUserPreferenceCommandsService.updateUserPreference).toHaveBeenCalledWith(
        ...
        it('應該在無效 ID 時返回錯誤', async () => {
            ...
            expect(mockUserPreferenceCommandsService.updateUserPreference).not.toHaveBeenCalled();
        });
    ...
    describe('deleteUserPreference', () => {
        it('應該成功刪除用戶偏好設定', async () => {
            ...
            mockUserPreferenceCommandsService.deleteUserPreference.mockResolvedValue({
                success: true,
                message: '用戶偏好設定刪除成功'
            });
            ...
            expect(mockUserPreferenceCommandsService.deleteUserPreference).toHaveBeenCalledWith(
                parseInt(preferenceId)
            );
            expect(ControllerResult.success).toHaveBeenCalledWith(
                mockResponse,
        ...
        it('應該在無效 ID 時返回錯誤', async () => {
            ...
            expect(mockUserPreferenceCommandsService.deleteUserPreference).not.toHaveBeenCalled();
        });
    ...
    describe('bulkCreateUserPreferences', () => {
        it('應該成功批量創建用戶偏好設定', async () => {
            ...
            mockUserPreferenceCommandsService.bulkCreateUserPreferences.mockResolvedValue({
                success: true,
                data: {
            ...
            expect(mockUserPreferenceCommandsService.bulkCreateUserPreferences).toHaveBeenCalledWith(preferencesData);
            expect(ControllerResult.created).toHaveBeenCalledWith(
                mockResponse,
                '批量創建偏好設定成功',
                {
        ...
        it('應該在沒有提供偏好設定陣列時返回錯誤', async () => {
            ...
            expect(mockUserPreferenceCommandsService.bulkCreateUserPreferences).not.toHaveBeenCalled();
        });
    ...
    describe('resetUserPreferences', () => {
        it('應該成功重設用戶偏好設定為默認值', async () => {
            ...
            mockUserPreferenceCommandsService.resetUserPreferences.mockResolvedValue({
                success: true,
            ...
            expect(mockUserPreferenceCommandsService.resetUserPreferences).toHaveBeenCalledWith(
                parseInt(userId)
            );
            expect(ControllerResult.success).toHaveBeenCalledWith(
                mockResponse,
        ...
        it('應該在無效用戶 ID 時返回錯誤', async () => {
            ...
            expect(mockUserPreferenceCommandsService.resetUserPreferences).not.toHaveBeenCalled();
        });
