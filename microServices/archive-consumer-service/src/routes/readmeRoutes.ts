...
router.get('/readme', (_req, res) => {
    try {
        ...
        const htmlContent = renderReadmeToHtml(readmeContent, 'Archive Consumer Service');
 ...
 */
export const createReadmeRoutes = (logger: any): Router => {
    logger.info('Creating README routes...');
    return router;
};
