...
class LangChainService:
    ...
    def generate_response(self, prompt: str, use_rag: bool = False, **kwargs) -> Dict[str, Any]:
        ...
        result = self.repository.generate_chat_response(prompt, use_rag=use_rag, **kwargs)
    ...
    def generate_conversational_response(self, prompt: str, use_rag: bool = False, **kwargs) -> Dict[str, Any]:
        ...
        result = self.repository.generate_conversational_response(prompt, use_rag=use_rag, **kwargs)
    ...
    def stream_generate(self, prompt: str, **kwargs) -> Generator[str, None, None]:
        ...
        yield from self.repository.stream_chat_response(prompt, **kwargs)
