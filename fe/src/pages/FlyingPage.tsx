      ...
      <div className="p-3 sm:p-6">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 gap-4">
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">無人機飛行控制與監控中心</p>
          </div>
                ...
                {isSimulateMode ? (
                  ...
                  <>
                    <button
                      ...
                      onClick={simulateFlyLogic.startSimulation}
                      disabled={
                        currentLogic.isLoading ||
                        !!currentLogic.error ||
                        simulateFlyLogic.isSimulating
                      }
                    >
                    ...
                    <button
                      ...
                      onClick={simulateFlyLogic.stopSimulation}
                      disabled={
                        currentLogic.isLoading ||
                        !!currentLogic.error ||
                        !simulateFlyLogic.isSimulating
                    ...
                    <button
                      ...
                      onClick={simulateFlyLogic.resetSimulation}
                    ...
                    <button
                      ...
                      onClick={simulateFlyLogic.fitToDrones}
                      disabled={
                        currentLogic.isLoading ||
                        !!currentLogic.error ||
                        simulateFlyLogic.dronesCount === 0
                      }
                    >
                      <span className="flex items-center justify-center gap-2">
                        <span className="text-lg">🎯</span>
                  ...
                  <>
                    ...
                    >
                      <span className="flex items-center justify-center gap-2">
                        <span className="text-lg">📍</span>
                        <span className="text-sm sm:text-base">新增飛行點</span>
                      </span>
                      <div className="absolute inset-0 bg-white/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
                    </button>
                    ...
                    >
                      <span className="flex items-center justify-center gap-2">
                        <span className="text-lg">🗑</span>
                        <span className="text-sm sm:text-base">清除飛行點</span>
                      </span>
                      <div className="absolute inset-0 bg-white/20 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
                    </button>
                  </>
                ...
                {isSimulateMode ? (
                  ...
                  <>
                    ...
                    <div className="bg-gradient-to-br from-green-900 to-teal-900 p-4 rounded-xl border border-green-700">
                      ...
                      <div className="text-lg font-bold text-gray-100">
                        {simulateFlyLogic.simulationStats.activeDrones}
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-blue-900 to-indigo-900 p-4 rounded-xl border border-blue-700">
                      ...
                      <div className="text-lg font-bold text-gray-100">
                        {simulateFlyLogic.simulationStats.completedDrones}
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-purple-900 to-pink-900 p-4 rounded-xl border border-purple-700">
                      ...
                      <div className="text-lg font-bold text-gray-100">
                        {simulateFlyLogic.simulationStats.currentStep}/{simulateFlyLogic.simulationStats.totalSteps}
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-yellow-900 to-amber-900 p-4 rounded-xl border border-yellow-700">
                      ...
                      <div className="text-lg font-bold text-gray-100">
                        {simulateFlyLogic.simulationStats.averageBattery}%
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-cyan-900 to-blue-900 p-4 rounded-xl border border-cyan-700">
                      ...
                      <div className="text-lg font-bold text-gray-100">
                        {simulateFlyLogic.simulationStats.coverageRadius} km
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-indigo-900 to-violet-900 p-4 rounded-xl border border-indigo-700">
                      ...
                      <div className="text-lg font-bold text-gray-100">
                        {simulateFlyLogic.simulationStats.elapsedTime}s
                      </div>
                    </div>
                    ...
                    <div className="bg-gradient-to-br from-rose-900 to-red-900 p-4 rounded-xl border border-rose-700">
                      ...
                      <div className="text-lg font-bold text-gray-100">
                        {simulateFlyLogic.simulationStats.estimatedCompletion}s
                      </div>
                    </div>
                  </>
                ) : (
